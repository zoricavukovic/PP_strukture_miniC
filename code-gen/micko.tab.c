...
{
       0,    64,    64,    75,    76,    80,    95,    98,   102,   140,
     141,   145,   181,   187,   188,   193,   192,   218,   220,   230,
     229,   239,   240,   244,   254,   255,   259,   260,   261,   262,
     266,   270,   280,   294,   296,   315,   317,   324,   330,   332,
     337,   381,   384,   390,   389,   409,   411,   423,   426,   432,
     437,   431,   450,   460
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_POINT", "_ID", "_INT_NUMBER", "_UINT_NUMBER", "_LPAREN", "_RPAREN",
  "_LBRACKET", "_RBRACKET", "_ASSIGN", "_SEMICOLON", "_STRUCT", "_AROP",
  "_RELOP", "ONLY_IF", "$accept", "program", "struct_list", "struct_id",
  "attribute_list", "struct_attribute", "global_struct_list",
  "global_struct", "function_list", "function", "$@1", "parameter", "body",
  "$@2", "variable_list", "variable", "statement_list", "statement",
  "compound_statement", "assignment_statement", "num_exp", "exp", "new_ID",
...
{
     -71,    36,    21,   -71,    41,    37,    49,    38,    45,   -71,
      46,    49,   -71,    48,   -71,    30,     0,   -71,   -71,    45,
      44,   -71,    50,    43,   -71,    51,    47,    52,   -71,    57,
      53,   -71,    55,    54,   -71,   -71,    58,   -71,   -71,    61,
      59,   -71,   -71,    56,     3,   -71,    62,    33,    -2,   -71,
     -71,   -71,   -71,   -71,    60,   -71,    65,   -71,   -71,     8,
     -71,   -71,    33,   -12,   -71,   -71,   -71,   -71,    66,    33,
      26,    33,    14,    33,    67,    19,   -71,    33,   -71,     5,
     -71,    17,   -71,    29,   -71,    33,   -71,   -71,   -71,   -71,
      33,    64,    63,    68,    63,    14,   -71,   -71
};
...
{
       3,     0,     9,     1,     0,     0,     0,     9,     5,     6,
       0,     2,    13,     0,    10,     0,     0,    15,    14,     0,
       0,    11,     0,     0,     7,     0,     0,     0,     4,    17,
       0,     8,     0,     0,    12,    18,     0,    21,    16,    19,
       0,    24,    22,     0,     0,    23,     0,     0,     0,    24,
      20,    25,    26,    27,     0,    28,    47,    29,    49,    36,
      41,    42,     0,     0,    33,    39,    35,    37,     0,     0,
       0,     0,     0,     0,     0,     0,    53,     0,    40,     0,
      30,     0,    48,     0,    50,    45,    38,    34,    31,    32,
       0,     0,    46,     0,    52,     0,    44,    51
};
...
static const yytype_int8 yypgoto[] =
{
     ...
     -71,   -71,   -71,   -71,   -71,   -71,    16,   -70,   -71,   -71,
     -61,     2,   -44,   -71,   -71,   -71,   -71,   -71,   -71,   -71,
     -71,   -71,   -71
};
...
{
      -1,     1,     2,     5,    16,    24,     6,     7,    11,    12,
      25,    33,    38,    41,    39,    42,    44,    51,    52,    53,
      63,    64,    65,    66,    67,    74,    93,    55,    56,    73,
      91,    84,    57
};
...
{
      54,    75,    82,    22,    76,    68,    77,    46,    79,    47,
      81,    48,    83,    69,    23,    68,    49,    50,    46,   -43,
      47,    88,    48,    77,    92,    97,    54,    49,    54,    94,
      46,    86,    47,    89,    48,    77,     3,    77,     4,    49,
      80,    59,    60,    61,    62,    20,    21,    77,    90,     8,
       9,    54,    10,    15,    17,    13,    19,    26,    27,    28,
      32,    30,    29,    35,    40,    70,    36,    43,    31,    34,
      72,    37,    45,    58,    78,    71,    95,    14,    85,    87,
      96,    77,    18
};

static const yytype_int8 yycheck[] =
{
      44,    62,    72,     3,    16,     7,    18,     4,    69,     6,
      71,     8,    73,    15,    14,     7,    13,    14,     4,    11,
       6,    16,     8,    18,    85,    95,    70,    13,    72,    90,
       4,    12,     6,    16,     8,    18,     0,    18,    17,    13,
      14,     8,     9,    10,    11,    15,    16,    18,    19,     8,
      13,    95,     3,     8,     8,    17,     8,    13,     8,    16,
       3,    14,    11,     8,     3,    49,    12,     8,    16,    16,
       5,    13,    16,    11,     8,    15,    12,     7,    11,    77,
      12,    18,    11
};
...
{
       0,    22,    23,     0,    17,    24,    27,    28,     8,    13,
       3,    29,    30,    17,    27,     8,    25,     8,    30,     8,
      15,    16,     3,    14,    26,    31,    13,     8,    16,    11,
      14,    16,     3,    32,    16,     8,    12,    13,    33,    35,
       3,    34,    36,     8,    37,    16,     4,     6,     8,    13,
      14,    38,    39,    40,    43,    48,    49,    53,    11,     8,
       9,    10,    11,    41,    42,    43,    44,    45,     7,    15,
      37,    15,     5,    50,    46,    41,    16,    18,     8,    41,
      14,    41,    38,    41,    52,    11,    12,    42,    16,    16,
      19,    51,    41,    47,    41,    12,    12,    38
};
...
static const yytype_int8 yyr1[] =
{
      ...
      27,    28,    28,    29,    29,    31,    30,    32,    32,    34,
      33,    35,    35,    36,    37,    37,    38,    38,    38,    38,
      39,    40,    40,    41,    41,    42,    42,    42,    42,    42,
      43,    44,    44,    46,    45,    47,    47,    48,    48,    50,
      51,    49,    52,    53
};
...
#line 81 "micko.y"
        {
        if (lookup_symbol((yyvsp[0].s), STRUCT) != NO_INDEX)
           err("already defined struct with same name '%s'", (yyvsp[0].s));
        else{
           struct_idx = insert_symbol((yyvsp[0].s), STRUCT, NO_ATR, NO_ATR, NO_ATR);
...
#line 103 "micko.y"
      {
         ...
         for (i; i < num_attribute; i++){
            if (strcmp(attr_array[i], (yyvsp[-1].s)) == 0){
            	found = 1;
               err("already declared attribute in same struct with same name '%s'", (yyvsp[-1].s));
               break;
            }
         }
         if (found == 0){
            attr_array[num_attribute] = (yyvsp[-1].s);
		...
		strcat(name_with_extension, (yyvsp[-1].s));
		
		
	    struct_atribute* param_types = attribute_map[struct_idx];
	    struct_atribute new_attr;
	    new_attr.type = (yyvsp[-2].i);
	    strcpy(new_attr.ime, (yyvsp[-1].s));
...
#line 145 "micko.y"
                                    {
		int idx_struct_for_variable = lookup_symbol((yyvsp[-2].s), STRUCT);
        if(idx_struct_for_variable == NO_INDEX)
           err("'%s' undeclared structure name", (yyvsp[-2].s));		//atr3
        else{
           if(lookup_symbol((yyvsp[-1].s), STRUCT_VAR) == NO_INDEX){
              int idx = insert_symbol((yyvsp[-1].s), STRUCT_VAR, 0, idx_struct_for_variable, NO_ATR);
              ...
              for(; i < num_atr; i++){
            	...
            	const char* name = get_name(struct_idx);
				name_with_extension = malloc(strlen(name)+1+50); /* make space for the new string (should check the return value ...) */
				strcpy(name_with_extension, (yyvsp[-1].s)); /* copy name into the new var */
...
#line 338 "micko.y"
  {
    ...
    int idx_struct_var = lookup_symbol((yyvsp[-2].s), STRUCT_VAR);
    if (idx_struct_var == NO_INDEX){
		err("undefined struct var '%s'", (yyvsp[-2].s));
		...
		for(; i < num_atr; i++){
			...
			if (strcmp(atr.ime, (yyvsp[0].s)) == 0){
		   		found = 1;
		   		break;
			}
		}
		if (found == 0){
		   err("undefined struct attr '%s'", (yyvsp[0].s));
			...
			// i kao povrtanu vrednost pojma indx u tabeli da bi mogao da dohvati tip tog atributa(to je drugi id)
				...
				char* name_with_extension;
            	const char* name = (yyvsp[-2].s);
				name_with_extension = malloc(strlen(name)+1+50); /* make space for the new string (should check the return value ...) */
				strcpy(name_with_extension, name); /* copy name into the new var */
				strcat(name_with_extension, "_"); /* add the extension */
				strcat(name_with_extension, (yyvsp[0].s));
				printf("%s", name_with_extension);
				(yyval.i) = lookup_symbol_struct(name_with_extension, STRUCT_ATR, idx_struct_var);
		}
	}
